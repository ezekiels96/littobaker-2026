   ...
   class="group relative overflow-hidden rounded-3xl border border-black/5 bg-white/70 p-8 shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:shadow-xl">
    ...
    <div class="mt-6 inline-flex items-center rounded-full border border-black/5 bg-white/70 px-4 py-2 font-gummy text-sm font-extrabold lowercase shadow-sm transition group-hover:bg-white">
        ...
        <a href="{{ route('admin.home.edit') }}"
           class="group relative overflow-hidden rounded-3xl border border-black/5 bg-white/70 p-8 shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:shadow-xl">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="min-w-0">
                    <div class="font-gummy text-2xl font-extrabold lowercase text-lb-ink">home page</div>
                    <div class="mt-1 font-gummy text-sm font-bold lowercase text-lb-muted">edit hero text, images, and feature section ♡</div>
                </div>
            </div>
        ...
        <a href="{{ route('admin.about.edit') }}"
           class="group relative overflow-hidden rounded-3xl border border-black/5 bg-white/70 p-8 shadow-lg backdrop-blur transition hover:-translate-y-0.5 hover:shadow-xl">
            <div class="pointer-events-none absolute -top-20 -left-20 h-56 w-56 rounded-full bg-lb-yellow/20 blur-3xl"></div>
            <div class="pointer-events-none absolute -bottom-20 -right-20 h-56 w-56 rounded-full bg-lb-lilac/20 blur-3xl"></div>

            <div class="flex items-center gap-4">
                <div class="grid h-14 w-14 place-items-center rounded-2xl border border-black/5 bg-gradient-to-br from-lb-yellow/60 to-lb-lilac/30 shadow">
                    <span class="text-2xl">✨</span>
                </div>
                <div class="min-w-0">
                    <div class="font-gummy text-2xl font-extrabold lowercase text-lb-ink">about page</div>
                    <div class="mt-1 font-gummy text-sm font-bold lowercase text-lb-muted">edit your story, photo, and content ♡</div>
                </div>
            </div>
